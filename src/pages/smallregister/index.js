...
class SmallLogin extends React.Component {
        ...
        return (
            <div>
                <Center>
                    ...
                    <NameInput type="text" placeholder={"注册账号"} value={NameInputVal} onChange={this.handleName.bind(this)} />
                    <PassInput type="password" placeholder={"密码"} value={PassInputVal} onChange={this.handlePassword.bind(this)} />

                    <div className="btn" onClick={this.handleLogin.bind(this)} >注册</div>
                </Center>
                <Choose>
                    <div className="left">
                        <input type="checkbox" />
    ...
    handleLogin() {
        ...
        let { NameInputVal, PassInputVal } = this.state;
        console.log(NameInputVal,PassInputVal)
        this.props.handleRegisterAsync(NameInputVal,PassInputVal)
